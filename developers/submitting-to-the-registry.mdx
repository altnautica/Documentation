...
| `queued_for_review` | Risk band High or Critical, vendor-binary flag set, license is non-OSS, or the analyzer flagged a critical pattern. | Wait for human review. Typical SLA target 5 business days. |
