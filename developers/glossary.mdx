...
| **Operator** | The human running ADOS. Approves permissions, grants and revokes them through the node's Extensions tab. A grant or a revocation takes effect at runtime, with no agent restart. |
