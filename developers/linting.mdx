...
| FS001-open-write | info | File opened for writing (verify the path is under `ctx.data_dir`, `config_dir`, or `temp_dir`) |
...
| ARC003-read-fail | error | An archive entry could not be read |
