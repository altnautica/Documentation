...
Open Mission Control. Open the node from the fleet, switch to its
**Extensions** tab and click **Install from file**. Drag the `.adosplug` into the
dialog, review the manifest preview, approve the requested permissions, and click
**Install**.
