...
The hello panel in [Your first plugin](/developers/your-first-plugin) is
GCS-only because it reads normalized telemetry and renders a readout. The Thermal Camera plugin is
...
public safety and lifecycle topics (`vehicle.armed`, `vehicle.geofence_breach`,
