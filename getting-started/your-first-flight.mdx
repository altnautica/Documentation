...
- A drone with an ArduPilot or PX4 flight controller
- A charged battery
...
Make sure you are using a supported firmware. Mission Control works with ArduPilot 4.0+, PX4 1.12+, and Betaflight 4.3+.
