...
<Steps>
  <Step title="Connect your flight controller">
    ...
    **Over the agent (field):**
    ...
    <Frame caption="Mission Control top bar showing a connected ArduPilot copter">
      <img src="/images/dashboard/connected-topbar.png" alt="Top navigation bar showing ArduPilot Copter 4.5 connected with GPS fix and battery status" />
    </Frame>
  </Step>
  ...
  <Step title="Arm the drone">
    ...
    <Frame caption="Flight Control tab with armed drone and gamepad controls visible">
      <img src="/images/dashboard/flight-control-armed.png" alt="Flight Control tab showing armed status, gamepad stick indicators, and throttle slider" />
    </Frame>
  </Step>
