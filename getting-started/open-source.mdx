---
title: "Open Source"
description: "GPLv3 software, CC0 1.0 hardware and docs. What you can do with ADOS."
icon: "code-branch"
---
...
- [ADOS Drone Agent](https://github.com/altnautica/ADOSDroneAgent) (Rust and Python)
...
### Hardware: CC0 1.0 Universal

Hardware designs (schematics, PCB layouts, mechanical drawings, enclosures, 3D-printable accessories) are dedicated to the public domain under **CC0 1.0 Universal**.

**What CC0 1.0 means for you:**

- You can manufacture boards from the designs
- You can modify the designs
- You can sell the modified designs commercially with no obligation to share your revisions
- You do not need to credit Altnautica
- You can re-licence a derivative under any licence, including closed and proprietary
- There is nothing for your legal team to review

CC0 is the most permissive open-licence option available. It is a public domain dedication with a fallback permissive licence for jurisdictions that do not recognise public domain.

<Note>
Not everything Altnautica builds is open. The open platform (hardware under CC0, firmware under GPLv3, docs under CC0) is deliberately maximally open. Altnautica also ships commercial products on top of the open layer which are fully proprietary. Both tracks are first-class.
</Note>

### Documentation: CC0 1.0 Universal

Documentation (this site, guides, tutorials) is dedicated to the public domain under **CC0 1.0 Universal**. Share it, adapt it, translate it, embed it in a book or a course, with no obligations.
...
flowchart TB
    ...
    subgraph "Public Domain (CC0 1.0)"
...
| FC configuration | Vendor-only tool | ADOS Mission Control (60+ panels) |
| Mission planning | Vendor-only tool | ADOS Mission Control (7 patterns) |
| Hardware designs | Proprietary | CC0 1.0 (public domain) |
...
ADOS Mission Control is cross-platform (runs anywhere a browser runs) and supports multiple firmware families (ArduPilot, PX4, Betaflight, iNav). If you are on macOS or Linux, or you need Betaflight support, Mission Control is an alternative.

### Betaflight Configurator

The Betaflight Configurator is a Chrome app / Electron app for configuring Betaflight flight controllers. ADOS Mission Control includes full MSP v1/v2 protocol support and Betaflight-specific configuration panels (and iNav over the same MSP codec). You can configure a Betaflight FC from the same GCS you use for ArduPilot.

### DroneKit / pymavlink

DroneKit is a Python SDK for controlling MAVLink drones. It is no longer actively maintained. The ADOS Drone Agent builds on pymavlink (the actively maintained library) and provides a plugin SDK, a REST API, a TUI, and systemd service management on top.
