...
<Steps>
  <Step title="Open the Plan tab">
    ...
    <Frame caption="Mission Plan tab with an empty map ready for waypoint placement">
      <img src="/images/dashboard/plan-empty.png" alt="Mission planner showing a satellite map with the tools panel on the left" />
    </Frame>
  </Step>
  ...
  <Step title="Generate the survey pattern">
    ...
    <Frame caption="Survey grid pattern generated over a defined polygon area">
      <img src="/images/dashboard/survey-pattern.png" alt="Map showing a survey grid pattern with parallel flight legs and waypoints over a polygon area" />
    </Frame>
...
<Steps>
  ...
  <Step title="Switch to Auto">
    ...
    <Frame caption="Mission execution in Auto mode showing the drone's progress along the survey pattern">
      <img src="/images/dashboard/mission-executing.png" alt="Map view showing completed survey legs in green and remaining legs in blue with the drone position marked" />
    </Frame>
  </Step>
