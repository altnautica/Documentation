...
<CardGroup cols={3}>
  ...
  <Card title="Drone Agent" icon="microchip" href="/getting-started/quickstart-drone-agent">
    Hybrid Rust/Python software running on a companion computer aboard your drone. Native services handle video, cloud relay, and radio; Python powers the REST API, AI/ML, and hardware abstraction. MAVLink proxy, video pipeline, cloud relay, REST API.
  </Card>
...
**Researchers and engineers.** You need a scriptable drone platform with a REST API, a Python SDK, and the ability to extend the stack with custom integrations when your project needs it.
...
- Minimal SSH CLI: `ados`, `ados status`, `ados update`, and `ados uninstall`
