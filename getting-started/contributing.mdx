...
<CardGroup cols={2}>
  ...
  <Card title="ADOS Drone Agent" icon="microchip" href="https://github.com/altnautica/ADOSDroneAgent">
    Companion computer software. Python 3.11+, FastAPI, Rich, local setup webapp.
  </Card>
</CardGroup>
...
├── services/
│   ├── api/             # Standalone API service entrypoint
...
**API runtime facade.** API route modules should use the accessors in
`ados.api.runtime` for telemetry, FC, video, WFB-ng, script, and parameter
