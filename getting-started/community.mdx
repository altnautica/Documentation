---
title: "Community"
description: "Discord, GitHub, forums. Where to ask questions, report bugs, and share your builds."
icon: "users"
---
...
ADOS Mission Control was announced on the ArduPilot Discuss forum. The thread is a good place for ArduPilot-specific discussion.

**[discuss.ardupilot.org](https://discuss.ardupilot.org)** (search for "Altnautica" or "ADOS Mission Control")

The ArduPilot community is active and knowledgeable. If your question is about ArduPilot behavior (not ADOS-specific), posting there gives you access to the core ArduPilot developers and thousands of experienced users.
