...
<Tip>
For classroom setups, use the repository's no-hardware development flow on a
laptop. Students can send text commands over localhost UDP without a real drone.
</Tip>
