...
<Frame caption="The TUI dashboard running over SSH on a Radxa ROCK 5C Lite">
  <img src="/images/placeholder-tui-dashboard.png" alt="ADOS Drone Agent TUI dashboard showing telemetry, FC status, and service health" />
</Frame>
...
| Install method | `curl \| bash` one-liner |
...
- [CLI Reference](/drone-agent/cli-reference) for all available commands
- [TUI Dashboard](/drone-agent/tui-dashboard) for the terminal interface
