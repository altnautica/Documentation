...
<Frame caption="The drone node dashboard: status, reach addresses, and the surfaces below it">
  <img src="/images/dashboard/drone/home-full.png" alt="ADOS drone node dashboard showing status and access URLs" />
</Frame>
