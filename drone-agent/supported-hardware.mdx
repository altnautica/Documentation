...
description: "The 17 board profiles, tier system, and recommended hardware."
icon: "circuit-board"
...
<AccordionGroup>
  ...
  <Accordion title="Tier 3 (1-2 GB RAM)">
    Adds the full video pipeline, cloud relay, and OTA updates. This is the minimum tier for a useful companion computer on a real drone.

    **Enabled services:** All Tier 2 services plus `ados-video`, `ados-wfb`, `ados-cloud`, `ados-peripherals`, `ados-ota`
