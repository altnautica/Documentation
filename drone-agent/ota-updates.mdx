...
$ ados update
Checking for updates...
Update available: v0.49.26
Install v0.49.26? [y/N]: y
...
```bash
$ ados rollback
Rollback complete. Reverted to v0.49.25.
```

Roll back to a specific version:

```bash
$ ados rollback 0.49.24
Rollback complete. Reverted to v0.49.24.
```
...
curl -X POST "http://localhost:8080/api/ota/rollback?version=0.49.24" \
  -H "X-ADOS-Key: $KEY"
```
...
Last check: 2026-05-09T10:00:00
```
