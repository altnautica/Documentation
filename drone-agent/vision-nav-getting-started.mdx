...
If you picked a VIO mode you need to upload camera intrinsics + a
camera-IMU extrinsics file. The plugin accepts Kalibr-compatible
`camchain.yaml` files directly. If you do not have one yet, the GCS
sensors card has a Calibrate CTA that walks the capture.
