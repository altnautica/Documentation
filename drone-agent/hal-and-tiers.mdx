...
| Vision host and model registry | No | No | No | Yes |

### RAM guidelines

| Tier | Minimum RAM | Typical boards |
|------|------------|----------------|
| 1 | minimal | (no current board profile defaults here) |
| 2 | 256-512 MB | Raspberry Pi 3/CM3, Radxa Cubie A7Z, generic ARM64 |
| 3 | 1-2 GB | Raspberry Pi 4B/CM4, Jetson Nano, Radxa CM3, RV1126B |
| 4 | 4 GB+ | ROCK 5C Lite, RPi 5/CM5, Jetson Orin Nano, Orange Pi 5, Radxa CM4 |
