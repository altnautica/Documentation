...
Open the setup webapp Ground Station page or Mission Control Hardware tab. The
...
The receiver binds a UDP listener on `bat0:5801`. When a relay sends a join request over the mesh, it appears in the pending list on the OLED, setup webapp, and GCS Hardware tab.
