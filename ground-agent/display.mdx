...
The full ground-side reference for this flow lives at [Field pairing](/ground-agent/setup#field-pairing-on-the-oled).
...
<CardGroup cols={2}>
  ...
  <Card title="Set up a ground station" icon="handshake" href="/ground-agent/setup">
