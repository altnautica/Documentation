...
<Frame caption="A bench ground station with radio adapter, OLED, and four buttons">
  <img src="/images/placeholder-ground-agent-hardware.png" alt="Bench ground station with USB radio adapter, OLED display, and buttons" />
</Frame>
