...
| Mesh carrier RTL8812EU | batman-adv mesh between Ground Agents | 5 GHz, channel 36 |

The two adapters sit on separated 5 GHz channels so they do not interfere. If you change either channel, plan around it.
