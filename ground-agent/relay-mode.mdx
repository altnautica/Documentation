...
- **GCS Mission Control:** the Distributed RX tab shows a `ReceiverCard` with the relay's view of the receiver: mDNS name, `bat0` IP, fragment counters, last-seen age.
