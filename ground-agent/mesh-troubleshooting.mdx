...
description: "Symptoms and fixes for the most common mesh and pairing failures. journalctl queries, setup webapp checks, and recovery paths."
icon: "wrench"
---
...
**Symptom:** the setup webapp or Hardware tab reports the configured role correctly, but mesh health is down. `systemctl status ados-batman` shows `inactive (dead)`.
