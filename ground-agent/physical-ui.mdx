...
<Frame caption="The Link status screen: signal, bitrate, and FEC statistics">
  <img src="/images/ground-agent/display/carousel/link.png" alt="Ground station display showing WFB-ng link statistics" />
</Frame>
...
|-----------------|----------|
| No OLED | Agent skips the OLED service. All menu functions are available via the setup webapp and the ground-station panel in Mission Control |
