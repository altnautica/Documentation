...
| Transmit power ceiling | 15 dBm | The USB adapter browns out above roughly 18 dBm sustained on host power |
| Extension takeoff altitude | 1 to 120 m | Clamped in the extension command path |
