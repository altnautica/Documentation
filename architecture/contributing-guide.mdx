...
The agent is a Rust and Python hybrid. The long-running services are Rust binaries in `crates/`; Python carries AI and vision, the plugin runtime, setup and OTA, HAL detection, and the residual web API. A full dev setup needs both a Rust toolchain and Python.
