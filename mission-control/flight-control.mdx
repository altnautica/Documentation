...
The per-drone detail view also carries a Plugins tab for plugin surfaces installed on that drone (Follow-Me, Orbit, thermal overlay, gimbal control, and similar behaviors ship as plugins). See [Installing plugins](/mission-control/installing-plugins).
