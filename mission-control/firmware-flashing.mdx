...
description: "Flash ArduPilot, PX4, Betaflight, or iNav firmware over WebSerial."
icon: "microchip"
---
...
- **iNav:** Same WebUSB DFU path as Betaflight. The board enters DFU mode via MSP command or manual boot button, and the iNav binary is flashed through the STM32 bootloader.
