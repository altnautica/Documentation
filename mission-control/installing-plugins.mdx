...
description: "Install signed plugins per drone, review permissions, and manage what each drone runs."
icon: "puzzle-piece"
...
- **UI**: Mission Control slot contributions (fc.tab, video.overlay, drone.detail.tab, and more)
