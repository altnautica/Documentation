...
description: "A browser-based ground control station for ArduPilot, PX4, Betaflight, and iNav drones."
icon: "display"
...
<Frame caption="ADOS Mission Control dashboard with live drone telemetry">
  <img src="/images/dashboard/dashboard-overview.png" alt="Mission Control dashboard showing drone cards, map, and telemetry" />
</Frame>
...
Open `http://localhost:4000` and the dashboard fills with fourteen simulated aircraft plus a workstation node and a ground-station node. All panels, calibration wizards, and mission planning tools work in demo mode.
